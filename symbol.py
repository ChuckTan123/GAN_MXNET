...
def get_discriminator(no_bias=True, fix_gamma=True, epsilon=1e-5 + 1e-12):
...
if __name__ == "__main__":
    ...
    plot_dis = mx.viz.plot_network(dis)
    plot_dis.render("discriminator")
    gen = get_generator()
    plot_gen = mx.viz.plot_network(gen, shape={"rand": (1,100,1,1)})
    plot_gen.render("generator")
